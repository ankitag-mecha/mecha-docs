...
title: Monitoring and Analysing Machine Metrics
---
# Monitoring and Analysing Machine Metrics
...
7. **Explore in Grafana**:
   ...
   - For detailed guidance on how to visualize and explore the metrics data effectively in Grafana, refer to [How-to Guide: Query Metrics on Grafana](https://mecha-docs.pages.dev/docs/mecha-cloud/console/how-to-guides/metrics-on-grafana).
...
8. **Creating Alerts**:
   ...
   - For detailed guidance on configuring alerts, refer to the [Grafana Alerting Documentation](https://grafana.com/docs/grafana/latest/alerting/).

...
---
import addNet1Url from './assets/add-network1.png';
import addNet2Url from './assets/add-network2.png';
...
2. **Fill in the Network Details:**
    ...
    <img src={addNet1Url} alt="Add Network Details" />;
...
1. **Choose an Encryption Method:**
    ...
    - **Bring Your Own Key (BYOK):**
        ...
        <img src={addNet1Url} alt="Select Network Encryption" />;

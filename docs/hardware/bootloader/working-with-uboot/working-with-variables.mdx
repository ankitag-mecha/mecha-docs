...
# Variables Require to U-boot

To build u boot for mecha device you need to have this variables set on your machine 
...
this variables are required to build arm64 based u boot that is our target mecha platform.
...
To make variables persistent across sessions, add them to your shell configuration file (e.g.,
